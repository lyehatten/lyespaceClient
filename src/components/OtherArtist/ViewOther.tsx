    ...
    <div className={classes.root} >
      {
        ...
        <Typography variant="h5" display="inline">
          aka {props.profileData.stageName}
        </Typography> :
        undefined
      }
      <Divider/>
      ...
      <br/>
      {
        ...
        <div>
          ...
          <Typography variant="body1" className={classes.indent} paragraph={true}>
            {props.profileData.bio}
          </Typography>
        </div> : undefined
      }
      {
        ...
        <div className={classes.infoMargin}>
          ...
          <div className={classes.indent}>
            {
              props.profileData.genres.map(genre => <Typography variant="overline" 
              className={classes.tags} key={genre}>
                {genre}
              </Typography >)
            }
          </div>
      ...
      {
        props.profileData.instruments ? <div className={classes.infoMargin}>
        <Typography variant='h5' >Instruments: </Typography>
        <div className={classes.indent}>
          {
            props.profileData.instruments.map(inst => <Typography variant="overline" 
            className={classes.tags} key={inst}>{inst}</Typography >)
          }
        </div>
      </div> : undefined
      }
...

      {
        ...
        <div>
          ...
          {
            props.profileData.examples !== null ? 
            <div className={classes.insetHTML}
