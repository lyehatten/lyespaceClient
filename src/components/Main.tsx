        ...
        <React.Fragment>
            <Router>
                ...
                <Switch>
                    ...
                    <Route exact path="/artistview"><ArtistRoute updateArtistView={this.updateArtistView} logout={this.logout} token={this.state.token} userId={this.state.userId} role={this.state.role} artistView={this.state.artistView}/> </Route>
